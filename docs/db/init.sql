...
CREATE TABLE loan_request (
    ...
    annual_rate DECIMAL(8, 6) NOT NULL COMMENT '基准年利率（小数形式）',
    rate_float_bp INT DEFAULT 0 COMMENT '利率浮动幅度（单位：bp，正数为上浮，负数为下浮）',
...
CREATE TABLE repayment_plan (
    ...
    annual_rate DECIMAL(8, 6) NOT NULL COMMENT '基准年利率',
    rate_float_bp INT DEFAULT 0 COMMENT '利率浮动幅度（单位：bp）',
